  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="bg-surface border border-border rounded-lg shadow-sm p-5" aria-hidden="true">
  ...
  return (
    <div className="space-y-6" aria-label="Loading dashboard" aria-busy="true">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {[0,1].map(i => (
          <div key={i} className="bg-surface border border-border rounded-lg shadow-sm p-5 space-y-4">
